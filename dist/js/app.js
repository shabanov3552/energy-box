 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".js-open-menu-button")) document.addEventListener("click", function(e) {
                if (bodyLockStatus && e.target.closest(".js-open-menu-button")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
                if (e.target.closest(".js-close-menu-button") && document.documentElement.classList.contains("menu-open")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
            });
        ...
        function updatePosition() {
            ...
            if (isInViewport) {
                ...
                const visibleTop = Math.min(Math.max(0, viewportHeight - rect.top), totalScrollDistance);
